...
public class PacketKeeper {
    ...
    public Packet getPacket(PacketInfo packetInfo) throws PacketKeeperException {
        ...
        System.out.println("Packet retrieved from object store, now processing decryption and signature verification");
            if (is == null) {
                LOGGER.error(PacketManagerLogger.SESSIONID, PacketManagerLogger.REGISTRATIONID,
            ...
            System.out.println("Stack trace : " + ExceptionUtils.getStackTrace(e));
